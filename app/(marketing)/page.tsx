    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
          Deadline Drive helps team move
        </h1>
      ...
      >
        Collaborate,manage projects, and reach new producitvity peaks. From high
        rises to the home office, the way your team works is unique - accomplish
        it all with Deadline Drive
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up"> Get DeadLine Drive for free</Link>
      </Button>
    </div>
  );
};
